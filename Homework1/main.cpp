...
int main() {
	...
	LinkedList First;
	First.insertToFront("Hey");
	First.insertToFront("So");
	First.insertToFront("lol");
...
//{
//public:streambuf_switcher(ios& dest, ios& src): dest_stream(dest),saved_streambuf(dest.rdbuf(src.rdbuf())){}
//	~streambuf_switcher(){
