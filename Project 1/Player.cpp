...
{
    m_age++;
    m_arena->thePrevious().dropACrumb(m_row, m_col); // when the player stays in the same place drop a crumb is called
}
...
void Player::move(int dir)
{
    ...
    m_arena->thePrevious().dropACrumb(m_row, m_col); // after every move, drop a crumb is called
}

bool Player::shoot(int dir)
{
    m_age++;
    m_arena->thePrevious().dropACrumb(m_row, m_col); // when the player shoots, they stay in the same place, so drop a crumb is also called
