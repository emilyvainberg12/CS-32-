        ...
        else
        {
            switch (action[0])
            {
              ...
              case 'q':
                return;
              case 'p': //new function
                m_arena->thePrevious().showPreviousMoves();   //Call Show Previous Moves when "p" is pressed
                cout << "Press Enter to continue" <<endl;
                cin.ignore(10000,'\n');
                continue; // this ensures that the robots DON'T move after you exit the previous grid
